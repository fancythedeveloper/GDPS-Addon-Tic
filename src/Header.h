...
char XGDPS_creditsMain_credit_7_stringChar[] = "TicLos";
DWORD XGDPS_creditsMain_credit_7_string = (DWORD)XGDPS_creditsMain_credit_6_stringChar;
DWORD XGDPS_creditsMain_credit_7_length = sizeof(XGDPS_creditsMain_credit_6_stringChar) - 1;
char XGDPS_creditsMain_credit_8_stringChar[] = "Chomp64";
DWORD XGDPS_creditsMain_credit_8_string = (DWORD)XGDPS_creditsMain_credit_6_stringChar;
DWORD XGDPS_creditsMain_credit_8_length = sizeof(XGDPS_creditsMain_credit_6_stringChar) - 1;
char XGDPS_creditsMain_credit_9_stringChar[] = "LBlazen";
DWORD XGDPS_creditsMain_credit_9_string = (DWORD)XGDPS_creditsMain_credit_6_stringChar;
DWORD XGDPS_creditsMain_credit_9_length = sizeof(XGDPS_creditsMain_credit_6_stringChar) - 1;
